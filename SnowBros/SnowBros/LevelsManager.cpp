...
LevelsManager::LevelsManager() {
	...
	levels[0] = Levelblueprint(1, false, false, 3, 0, 0, 1.0f, "Snowy Village", "Standard");
	levels[1] = Levelblueprint(2, false, false, 4, 1, 0, 1.1f, "Ice Caves", "Standard");
	levels[2] = Levelblueprint(3, false, false,2, 2, 1, 1.2f, "Winter Forest", "Standard");
	levels[3] = Levelblueprint(4, false, false,2, 2, 2, 1.3f, "Frozen Lake", "Standard");
	levels[4] = Levelblueprint(5, true, false, 0, 0, 0, 1.4f,"Dark unground layer with dramatic lightning", "Bosslevel");
	levels[5] = Levelblueprint(6, false, false, 2, 2, 3, 1.5f, "Volcanic Wasteland", "Standard");
	levels[6] = Levelblueprint(7, false, false, 4, 4, 1,1.0f, "Haunted Castle", "Standard");
	levels[7] = Levelblueprint(8, false, false, 4, 3, 2,1.1f, "Alien Planet", "Standard");
	levels[8] = Levelblueprint(9, false, false, 2, 1, 2,1.2f, "Storm Clouds", "Standard");
